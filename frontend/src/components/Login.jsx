        ...
        <section className='h-[200vh] w-full bg-[#0072BC]'>
          <div className='h-[140vh] flex flex-col justify-center items-center w-full'>
            <div className='h-[120vh] w-11/12 bg-slate-300 rounded-lg flex items-center flex-col'>
                <div className='text-[#0072BC] font-semibold text-[2.5rem] mt-10'>WELCOME BACK USER</div>
                ...
                <div className='bg-white w-11/12 h-[40vh] rounded-lg mt-20 flex flex-col items-center'>
                    <form onSubmit={userLoginData} className='mt-5'>                        
                        ...
                        <div className='mt-5 font-semibold border-[#f58120] border-2 flex justify-center items-center h-[2rem] rounded-lg text-white bg-[#f58120] cursor-pointer hover:bg-white hover:text-[#f58120] transition-all duration-300'><button onClick={userLoginData}>LOG IN</button></div>
                    </form>
                </div>
            </div>
          </div>
