        ...
        <section className='h-[200vh] w-full bg-primary'>
          <div className='h-[140vh] flex flex-col justify-center items-center w-full'>
            <div className='h-[120vh] w-11/12 bg-slate-300 rounded-lg flex items-center flex-col'>
                <div className='text-primary font-semibold text-[2.5rem] mt-10'>WELCOME USER</div>
                ...
                <div className='bg-white w-11/12 h-[40vh] rounded-lg mt-20 flex flex-col items-center'>
                    <form onSubmit={userRegisterData} className='mt-5'>
                        ...
                        <div className='mt-5 font-semibold border-secondary border-2 flex justify-center items-center h-[2rem] rounded-lg text-white bg-secondary cursor-pointer hover:bg-white hover:text-secondary transition-all duration-300'><button onClick={userRegisterData}>SIGN UP</button></div>
                    </form>
                </div>
            </div>
          </div>
